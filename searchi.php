...
background-size: cover">
    ...
    <form action="searchi1.php" method="POST">
      <br>
        <input type="text" name="key" placeholder="Enter the item_id" 
            style="width:150px;height:35px;margin-left:15px;"><br><br>
        <button type="submit" class="btn btn-primary" name="s_submit" value="item_id" 
